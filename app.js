// Application Data - Corrected Structure
const cementData = {
        ...
        "32.5": {
            variants: {
                L: {
                    ...
                    standard_max: 52.5,
                    setting_time: 75,
                    available_for: ["CEM III/A", "CEM III/B", "CEM III/C"],
                ...
                R: {
                    ...
                    standard_max: 52.5,
                    setting_time: 75,
                    available_for: ["all_except_CEM_III_L"],
    ...
    // Cement TYPES only (no strength classes mixed in)
    types: [
        // CEM I - Portland Cement (TYPE ONLY)
        {
            id: 'cem1',
            name: 'CEM I',
            family: 'CEM I',
            category: 'common',
            clinker: '95-100%',
            description: 'اسمنت بورتلاندي نقي بأعلى محتوى كلنكر',
            applications: ['الخرسانة الإنشائية', 'التطبيقات عالية القوة', 'البناء العام'],
        ...
        // ALL 18 CEM II TYPES (TYPES ONLY - NO STRENGTH CLASSES)
        {
            id: 'cem2-a-s',
            name: 'CEM II/A-S',
            family: 'CEM II',
        ...
        // CEM III - Blast Furnace (TYPES ONLY)
        {
            id: 'cem3-a',
            name: 'CEM III/A',
            family: 'CEM III',
        ...
        // Sulfate Resistant Varieties (CORRECTED C3A REQUIREMENTS)
        {
            id: 'cem1-sr0',
            name: 'CEM I-SR 0',
            family: 'CEM I-SR',
            category: 'sulfate',
            clinker: '95-100%',
            description: 'Very low C3A Portland cement for severe sulfate exposure',
            applications: ['Severe sulfate environments', 'Seawater exposure', 'Chemical plants'],
            composition: { clinker: 100 },
            chemical_requirements: {
                c3a_limit: "= 0%",
                sulfate_32_5: "≤ 3.0%",
        ...
        },
        {
            ...
            category: 'sulfate',
            clinker: '95-100%',
            description: 'Low C3A Portland cement for moderate sulfate exposure',
            applications: ['Moderate sulfate conditions', 'Underground construction', 'Foundations'],
            composition: { clinker: 100 },
            chemical_requirements: {
                c3a_limit: "≤ 3%",
                sulfate_32_5: "≤ 3.0%",
        ...
        },
        {
            ...
            category: 'sulfate',
            clinker: '95-100%',
            description: 'Moderate C3A Portland cement for mild sulfate exposure',
            applications: ['Mild sulfate conditions', 'General construction', 'Infrastructure'],
            composition: { clinker: 100 },
            chemical_requirements: {
                c3a_limit: "≤ 5%",
                sulfate_32_5: "≤ 3.0%",
        ...
        },
        {
            ...
            clinker: '65-89%',
            additive: '11-35% Pozzolanic materials',
            description: 'Sulfate resistant pozzolanic cement',
            applications: ['Marine structures', 'Sewage treatment', 'Industrial floors'],
            composition: { clinker: 75, pozzolan: 25 },
            chemical_requirements: {
                c3a_limit: "≤ 9%",
                sulfate_content: "varies by strength class",
        ...
        },
        {
            ...
            clinker: '45-64%',
            additive: '36-55% Pozzolanic materials',
            description: 'High pozzolan sulfate resistant cement',
            applications: ['Severe sulfate environments', 'Chemical resistance', 'Long-term durability'],
            composition: { clinker: 55, pozzolan: 45 },
            chemical_requirements: {
                c3a_limit: "≤ 9%",
                sulfate_content: "varies by strength class",
        ...
        },
        {
            ...
            clinker: '20-64%',
            additive: '36-80% Slag',
            description: 'Sulfate resistant blast furnace cement',
            applications: ['Marine environments', 'Aggressive conditions', 'Infrastructure'],
            composition: { clinker: 40, slag: 60 },
            chemical_requirements: {
                c3a_limit: "No C3A requirement",
                sulfate_content: "up to 4.5%",
                chloride: "≤ 0.10%"
            },
            available_strength_classes: ["32.5", "42.5", "52.5"]
    ...
    // Legacy strength classes structure (for compatibility)
    strengthClassesLegacy: [
        {
            class: '32.5',
            standardStrength: '32.5-52.5',
            earlyStrength: '16.0',
            settingTime: '≥75',
            soundness: '≤10',
            applications: ['General purpose concrete', 'Masonry work', 'Non-structural elements'],
            description: 'Standard strength class for general construction applications'
        },
        {
            class: '42.5',
            standardStrength: '42.5-62.5',
            earlyStrength: '20.0',
            settingTime: '≥60',
            soundness: '≤10',
            applications: ['Structural concrete', 'Precast elements', 'General construction'],
            description: 'Medium strength class suitable for most structural applications'
        },
        {
            class: '52.5',
            standardStrength: '≥52.5',
            earlyStrength: '30.0',
            settingTime: '≥45',
            soundness: '≤10',
            applications: ['High-strength concrete', 'Rapid construction', 'Prestressed concrete'],
            description: 'High strength class for demanding structural applications'
        }
    ]
};
...
function renderCementTypes() {
    ...
    if (searchTerm) {
        filteredTypes = filteredTypes.filter(type => 
            ...
            type.family.toLowerCase().includes(searchTerm) ||
            type.description.toLowerCase().includes(searchTerm) ||
            type.applications.some(app => app.toLowerCase().includes(searchTerm))
        );
    }
...
function renderConstituents() {
    ...
    if (searchTerm) {
        filteredConstituents = cementData.constituents.filter(constituent => 
            constituent.name.toLowerCase().includes(searchTerm) ||
            constituent.category.toLowerCase().includes(searchTerm) ||
            constituent.description.toLowerCase().includes(searchTerm)
        );
    }
    ...
    const requirements = [
        {
            ...
            items: [
                ...
                'Sulfate content (as SO₃) ≤ 4.0%',
                'Chloride content ≤ 0.10%',
                'Pozzolanicity test: positive'
            ]
        },
        {
            ...
            icon: 'fas fa-ruler',
            items: [
                'Fineness (specific surface) ≥ 280 m²/kg',
                'Standard consistency: 26-33%',
                'Setting time: within specified limits',
                'Soundness: ≤ 10 mm',
                'Compressive strength: meet class requirements'
            ]
        },
        {
            ...
            items: [
                'Sulfate resistance (SR types)',
                'Alkali content declaration',
                'Heat of hydration (LH types)',
                'Early strength (R types)',
                'White cement specifications (W types)'
            ]
        }
    ];
        ...
        <div class="card">
            <div class="card-header">
                <div>
                    ...
                    <div class="card-subtitle">BS EN 197-1:2011 Standards</div>
                </div>
                <div class="card-icon">
                    <i class="${req.icon}"></i>
                </div>
...
function renderStrengthChart() {
    ...
    // Extract data for all variants from corrected structure
    const chartData = {
        labels: [],
        datasets: [
            {
    ...
    // Generate data for all strength class variants
    ...
    new Chart(ctx, {
        ...
        options: {
            ...
            plugins: {
                title: {
                    display: true,
                    text: 'All Strength Class Variants (N, R, L) - Corrected Requirements',
                    font: { size: 16 }
                },
                legend: {
                    position: 'top'
...
function renderCompositionChart() {
    ...
    // Count cement types by family
    const familyCounts = {};
    cementData.types.forEach(type => {
        const family = type.family.split('-')[0]; // Remove SR suffix for counting
    ...
    new Chart(ctx, {
        ...
        options: {
            ...
            plugins: {
                title: {
                    display: true,
                    text: 'Distribution of Cement Family Types (Corrected Structure)',
                    font: { size: 16 }
                },
                legend: {
                    position: 'bottom'
                ...
                tooltip: {
                    callbacks: {
                        label: function(context) {
                            ...
                            const percentage = ((count / cementData.types.length) * 100).toFixed(1);
                            return `${family}: ${count} types (${percentage}%)`;
                        }
                    }
                }
            }
...
// Detail Modal Functions - CORRECTED to show strength variants
                ...
                return `
                    <div style="background: var(--surface); margin: 15px 0; padding: 20px; border-radius: 10px; border: 1px solid var(--border);">
                        ...
                        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 15px;">
                            ${Object.entries(classData.variants).map(([variant, data]) => {
                                const isAvailable = data.available_for.includes('all_types') || 
                                                  data.available_for.includes(type.family) ||
                                                  (variant !== 'L' && data.available_for.includes('all_except_CEM_III_L'));
            ...
            ${Object.entries(classData.variants).map(([variant, data]) => `
                <div style="background: var(--surface); margin: 15px 0; padding: 20px; border-radius: 10px; border: 1px solid var(--border);">
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px;">
                        ...
                        <div>
                            <h6 style="color: var(--text-secondary); margin-bottom: 10px;">Available for:</h6>
                            <div style="font-size: 0.9rem; color: var(--text-secondary);">
                                ${data.available_for.includes('all_types') ? 
                                    '<span style="color: var(--success); font-weight: 500;">✓ All cement types</span>' :
                                    data.available_for.map(type => `<span>• ${type}</span>`).join('<br>')}
                            </div>
                        </div>
                    </div>
...
function updateCreditsInfo() {
    if (cementData.credits) {
        ...
        document.getElementById('preparedEmail').textContent = cementData.credits.email;
        document.getElementById('preparedEmail').href = `mailto:${cementData.credits.email}`;
